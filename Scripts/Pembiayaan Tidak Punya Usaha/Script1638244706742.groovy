...
WebUI.click(findTestObject('PEMBIAYAAN/RB-TIDAKMEMILIKIUSAHA'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('Tab 1 Non Usaha')

WebUI.click(findTestObject('PEMBIAYAAN/TOMBOL-SELANJUTNYA'))

//TAB 2
WebUI.click(findTestObject('PEMBIAYAAN/RB-KTPSESUAI'))
...
WebUI.selectOptionByIndex(findTestObject('PEMBIAYAAN/PILIHAN_PEKERJAAN'), '4')

WebUI.click(findTestObject('PEMBIAYAAN/RB-STATUSTETAP'))
...
WebUI.setText(findTestObject('PEMBIAYAAN/TEXT-NOPLN'), '758473627381')
...
WebUI.takeFullPageScreenshotAsCheckpoint('Tab 2 Non Usaha')
...
WebUI.takeFullPageScreenshotAsCheckpoint('Tab 3 Non Usaha')
...
WebUI.takeFullPageScreenshotAsCheckpoint('Tab 4 Non Usaha')

WebUI.click(findTestObject('KREDIT KENDARAAN/TOMBOL-AJUKAN'))

WebUI.delay(5)

WebUI.takeFullPageScreenshotAsCheckpoint('Ringkasan Non Usaha')
